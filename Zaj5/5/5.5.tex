...
\path (decide2) -| node [near start] {no} (block1);
\path (decide2) -| node [near start] {yes} (block2);
\path (write) -- (stop);
\path (block2.south)-- ($ (block2.south) + (0,-0.4) $)-- ($ (block1.south) + (0,-0.4) $) -- ++(-1.4,0) |- ($ (decide.north) + (0,0.4) $);
\path (block1.south) -- ($ (block1.south) + (0,-0.4) $) -- ++(-1.4,0) |- ($ (decide.north) + (0,0.4) $);
